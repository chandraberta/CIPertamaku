...
$sql = "INSERT INTO komen (nama, email, komentar)
...
$sqld = "DELETE FROM komen WHERE id=$nomor";
...
$panggil_db = mysqli_query($conn, "SELECT * FROM komen");
	echo "<h3>Komentar</h3>";
	echo "<br/>";
	echo "<table>";
	echo "<tr>";
